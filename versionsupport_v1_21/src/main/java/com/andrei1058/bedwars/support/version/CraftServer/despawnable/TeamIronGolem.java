...
public class TeamIronGolem extends DespawnableProvider<org.bukkit.entity.IronGolem> {
    ...
    public @NotNull org.bukkit.entity.IronGolem spawn(@NotNull DespawnableAttributes attr, @NotNull Location location, @NotNull ITeam team, VersionSupport api) {

        var bukkitEntity = (org.bukkit.entity.IronGolem) Objects.requireNonNull(location.getWorld()).spawnEntity(location, EntityType.IRON_GOLEM);
